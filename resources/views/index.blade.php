...
<div class="layout-page indexPage">
    <div class="layout-content" >
                                ...
                                <div class="col-lg-10 col-md-10 col-md-offset-1 col-xs-12" id="report">
                                    @if(isset($reports_tags))
                                        @foreach($reports_tags as $tag)
                                            <a href="{{ route('get-reports-news', $tag->slug) }}" class="reportItem c-bg-center"
                                               style="background-image: @if(count($tag->photos) > 0)url('uploaded/{{$tag->photos{0}->source}}')@else url('images/reports-notice/concert.png') @endif" ng-cloak>
        ...
        <section>
            <div class="text-center">
                <h2 class="indexSectionTitle">{{$trans->index_news_section_title}}</h2>
            </div>
            <div class="container-fluid">
                <div class="row">
