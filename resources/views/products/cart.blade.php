...
<script type="text/ng-template" id="template/ngCart/cart.html">
    ...
    <div ng-show="ngCart.getTotalItems() === 0">
        <div class="text-center newsListTitle">
            <h1 class="page-title  rowed">{{$trans->cart_title}}</h1>
        </div>
        ...
        <md-toolbar class="md-warn cartWarning">
            <div class="md-toolbar-tools">
                ...
                <h2 class="md-flex">{{$trans->cart_text_empty}}</h2>
            </div>
        </md-toolbar>
    </div>
        ...
        <table class="mainCart">
            <thead>
                <tr>
                    ...
                    <th class="itemQty"><span>{{$trans->cart_qty}}</span></th>
                    <th class="itemAmount">{{$trans->cart_price}}</th>
                    <th class="itemTotal">{{$trans->cart_total}}</th>
                </tr>
            </thead>
            ...
            <tbody >
                <tr class="itemRow" ng-repeat="item in ngCart.getCart().items track by $index">
                    ...
                    <td class="itemAmount">
                        <span >@{{item.getPrice()}} {{$trans->valute}}</span>
                    </td>

                    <td class="itemTotal">
                        <span >@{{ item.getTotal()}} {{$trans->valute}}</span> 
                    </td>
            ...
            <div class="row" >
                    ...
                    <div class="col-md-5 col-md-offset-1 col-md-push-6 cartCheckout">
                        <div class="row">
                            ...
                            <div id="order_review">
                                <h3 class="order_review_heading">{{$trans->cart_order_title}}</h3>
                                    <table class="shop-info">
                                        <tbody>
                                            <tr>
                                                <th>{{$trans->cart_total}}</th>
                                                <td><span class="amount">@{{ ngCart.totalCost() }} {{$trans->valute}}</span></td>
                                            </tr>
                                        </tbody>
                                    </table>
                            </div>
                        ...
                        <md-button type="submit"  class="check-accept visible-md visible-lg md-raised md-warn md-block">{{$trans->cart_button}}</md-button>
                        ...
                        <div class="row">
                            ...
                            <div id="order_review">
                                ...
                                <div class="cartAuth">
                                    ...
                                    <div class="form-group">
                                    <md-input-container class="md-block">
                                            <label>{{$trans->modal_placeholder_email}}</label>
                                           ...
                                           <div ng-messages="cartForm.cartEmail.$error" role="alert">
                                               <div ng-message="required">{{$trans->modal_validation_required}}</div>
                                        <div ng-message="minlength">{{$trans->modal_validation_email}}</div>
                                        <div ng-message="pattern">{{$trans->modal_validation_email_pattern}}</div>
                                            </div>
                                        </md-input-container>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <md-input-container class="md-block">
                                            <label>{{$trans->modal_placeholder_address}}</label>
                                            ...
                                            <div ng-messages="cartForm.cartAdress.$error" role="alert" multiple>
                                                <div ng-message="required">{{$trans->modal_validation_required}}</div>
                                                <div ng-message="minlength">{{$trans->modal_validation_address_pattern}}</div>
                                            </div>
                                        </md-input-container>
                                    </div>
                                    <div class="form-group">
                                    <md-input-container class="md-block">
                                          ...
                                          <textarea class="form-control" ng-minlength="5" required name="cartMessage" rows="5" md-select-on-focus placeholder="{{$trans->cart_contact_message_placeholder}}" ng-model="project.message"></textarea>
                            ...
                            <md-button type="submit"  class="check-accept visible-sm visible-xs md-raised md-warn md-block">{{$trans->cart_button}}</md-button>

                            <md-button class="trigger-cart-clear" hide ng-click="ngCart.empty()"></md-button>
